"""
Technology Review Board - Main entry point with integrated visualization server.
"""
...
# Updated to work when running from src directory
visualization_dir = Path(__file__).parent / "visualization"
templates_dir = visualization_dir / "templates"
