"""
Kernel provider module for centralized kernel management.
...
class KernelProvider:
    ...
    def _create_kernel() -> Kernel:
        ...
        # If we get here, we couldn't configure the service
        error_msg = "Could not configure Azure OpenAI service. Check your environment variables (AZURE_OPENAI_ENDPOINT, AZURE_OPENAI_API_KEY, AZURE_OPENAI_DEPLOYMENT)."
